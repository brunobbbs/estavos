		...
		********************************/
		...
		function createThumbs(container,opt) {
			...
			container.find('>ul:first >li').each(function(i) {
							...
							bullets.append('<div class="bullet thumb" style="width:'+opt.thumbWidth+'px;height:'+opt.thumbHeight+'px;"><img alt="" src="'+src+'"></div>');
		...
		function prepareSlides(container,opt) {
			...
			container.find('>ul:first >li >img').each(function(j) {
				...
				if (isIE(8)) {
					...
					pari.find('.tp-bgimg').append('<img alt="" class="ieeightfallbackimage defaultimg" src="'+src+'" style="width:100%">');
				}
			   ...
			   if (isIE(8)) {
				...
				if (vorh == "horizontal") {
					...
					for (var i=0;i<opt.slots;i++) {
							...
							if (isIE(8)) {
							   sh.find('.slot ').last().find('.slotslide').append('<img alt="" class="ieeightfallbackimage" src="'+imgsrc+'" style="width:100%">');
				...
				for (var j=0;j<opt.slots;j++) {
					...
					for (var i=0;i<opt.slots;i++) 	{
						...
						if (isIE(8)) {
							...
							sh.find('.slot ').last().find('.slotslide').append('<img alt="" src="'+imgsrc+'">');
							ieimgposition(sh,opt);
						}
